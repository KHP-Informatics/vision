...
data <- read.csv("/Users/lilifang/KCL/KCL_Angus/RE-STAR-Angus-Susie/All interviewees responses and the corresponding representative words_withoutNONE_updatedV4.csv",header=TRUE,sep=",",na.strings = NULL)
summary(data)
dim(data)
